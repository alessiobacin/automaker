...
/** Claude Code preset - default Claude models (latest 4.5 series) */
export const CLAUDE_PRESET: PhaseModelConfig = {
  enhancementModel: { model: 'sonnet-4.5' },
  fileDescriptionModel: { model: 'haiku-4.5' },
  imageDescriptionModel: { model: 'sonnet-4.5' },
  validationModel: { model: 'sonnet-4.5' },
  specGenerationModel: { model: 'opus-4.5' },
  featureGenerationModel: { model: 'sonnet-4.5' },
  backlogPlanningModel: { model: 'opus-4.5' },
  projectAnalysisModel: { model: 'sonnet-4.5' },
  suggestionsModel: { model: 'sonnet-4.5' },
  memoryExtractionModel: { model: 'haiku-4.5' },
};

/** Cursor preset - default Cursor models (4.5 series optimized) */
export const CURSOR_PRESET: PhaseModelConfig = {
  enhancementModel: { model: 'cursor-sonnet-4.5' },
  fileDescriptionModel: { model: 'cursor-haiku-4.5' },
  imageDescriptionModel: { model: 'cursor-sonnet-4.5' },
  validationModel: { model: 'cursor-sonnet-4.5' },
  specGenerationModel: { model: 'cursor-opus-4.5' },
  featureGenerationModel: { model: 'cursor-sonnet-4.5' },
  backlogPlanningModel: { model: 'cursor-opus-4.5' },
  projectAnalysisModel: { model: 'cursor-sonnet-4.5' },
  suggestionsModel: { model: 'cursor-sonnet-4.5' },
  memoryExtractionModel: { model: 'cursor-haiku-4.5' },
};

/** Codex preset - best Codex models for coding (GPT-5 series) */
export const CODEX_PRESET: PhaseModelConfig = {
  enhancementModel: { model: 'codex-gpt-5.2' },
  fileDescriptionModel: { model: 'codex-gpt-5.1-codex-mini' },
  imageDescriptionModel: { model: 'codex-gpt-5.2' },
  validationModel: { model: 'codex-gpt-5.2-codex' },
  specGenerationModel: { model: 'codex-gpt-5.2-codex' },
  featureGenerationModel: { model: 'codex-gpt-5.1-codex-max' },
  backlogPlanningModel: { model: 'codex-gpt-5.2-codex' },
  projectAnalysisModel: { model: 'codex-gpt-5.2' },
  suggestionsModel: { model: 'codex-gpt-5.1-codex-max' },
  memoryExtractionModel: { model: 'codex-gpt-5.1-codex-mini' },
};

/** OpenCode preset - best native OpenCode free models */
export const OPENCODE_PRESET: PhaseModelConfig = {
  enhancementModel: { model: 'opencode/big-pickle' as OpencodeModelId },
  fileDescriptionModel: { model: 'opencode/gpt-5-nano' as OpencodeModelId },
  imageDescriptionModel: { model: 'opencode/big-pickle' as OpencodeModelId },
  validationModel: { model: 'opencode/big-pickle' as OpencodeModelId },
  specGenerationModel: { model: 'opencode/grok-code' as OpencodeModelId },
  featureGenerationModel: { model: 'opencode/big-pickle' as OpencodeModelId },
  backlogPlanningModel: { model: 'opencode/grok-code' as OpencodeModelId },
  projectAnalysisModel: { model: 'opencode/big-pickle' as OpencodeModelId },
  suggestionsModel: { model: 'opencode/big-pickle' as OpencodeModelId },
  memoryExtractionModel: { model: 'opencode/gpt-5-nano' as OpencodeModelId },
};

/** OpenRouter preset - best paid OpenRouter models for coding (top performance) */
export const OPENROUTER_PRESET: PhaseModelConfig = {
  enhancementModel: { model: 'openrouter/deepseek/deepseek-v3.2' as OpencodeModelId },
  fileDescriptionModel: { model: 'openrouter/google/gemini-2.5-flash-lite' as OpencodeModelId },
  imageDescriptionModel: { model: 'openrouter/google/gemini-2.5-pro' as OpencodeModelId },
  validationModel: { model: 'openrouter/anthropic/claude-sonnet-4.5' as OpencodeModelId },
  specGenerationModel: { model: 'openrouter/anthropic/claude-opus-4.5' as OpencodeModelId },
  featureGenerationModel: { model: 'openrouter/qwen/qwen3-coder' as OpencodeModelId },
  backlogPlanningModel: { model: 'openrouter/anthropic/claude-opus-4.5' as OpencodeModelId },
  projectAnalysisModel: { model: 'openrouter/google/gemini-2.5-pro' as OpencodeModelId },
  suggestionsModel: { model: 'openrouter/qwen/qwen3-coder' as OpencodeModelId },
  memoryExtractionModel: { model: 'openrouter/google/gemini-2.5-flash-lite' as OpencodeModelId },
};

/** OpenRouter FREE preset - best free OpenRouter models for coding (zero cost) */
export const OPENROUTER_FREE_PRESET: PhaseModelConfig = {
  enhancementModel: { model: 'openrouter/qwen/qwen3-coder:free' as OpencodeModelId },
  fileDescriptionModel: { model: 'openrouter/google/gemini-2.0-flash-exp:free' as OpencodeModelId },
  imageDescriptionModel: {
    model: 'openrouter/google/gemini-2.0-flash-exp:free' as OpencodeModelId,
  },
  validationModel: { model: 'openrouter/deepseek/deepseek-r1:free' as OpencodeModelId },
  specGenerationModel: { model: 'openrouter/deepseek/deepseek-r1:free' as OpencodeModelId },
  featureGenerationModel: { model: 'openrouter/qwen/qwen3-coder:free' as OpencodeModelId },
  backlogPlanningModel: { model: 'openrouter/deepseek/deepseek-v3-base:free' as OpencodeModelId },
  projectAnalysisModel: { model: 'openrouter/mistralai/devstral-2512:free' as OpencodeModelId },
  suggestionsModel: { model: 'openrouter/qwen/qwen3-coder:free' as OpencodeModelId },
